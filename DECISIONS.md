...
| D022 | Refine G003 T007 after the A004 dry run to make the production tool-preparation seam, effect/replay-aware policy conformance proof, canonicalization proof, and failure-stage nomenclature explicit without changing the G003 domain model, ADR-0003, Goal boundary, completed Tasks, or Task IDs. | accepted |
