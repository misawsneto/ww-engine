...
- Now — G003 — active durable provider-neutral Agent kernel under accepted ADR-0003; T007 is under D022 replanning and implementation is blocked until the corrected packet is approved and the lock is removed.
