...
- Now — G003 — active durable provider-neutral Agent kernel under accepted ADR-0003; T007 is the next implementation slice under approved SPEC/PLAN v2, D022-hardened T007 requirements, and `goals/G003-thin-agent-kernel/HANDOFF.md`.
